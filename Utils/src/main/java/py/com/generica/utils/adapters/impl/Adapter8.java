 ...
 */
public abstract class Adapter8<TFrom, TTo, P1, P2, P3, P4, P5, P6, P7, P8> implements Adapter<TFrom, TTo> {
    ...
    public final TTo adapt(TFrom obj, Object... args) {
        ...
        P8 p8 = Args.argv(args, 7, null);
        return adapt(obj, p1, p2, p3, p4, p5, p6, p7, p8);
    }

    public abstract TTo adapt(TFrom obj, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8);
