 ...
 */
public abstract class Adapter5<TFrom, TTo, P1, P2, P3, P4, P5> implements Adapter<TFrom, TTo> {
    ...
    public final TTo adapt(TFrom obj, Object... args) {
        ...
        return adapt(obj, p1, p2, p3, p4, p5);
    }

    public abstract TTo adapt(TFrom obj, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5);
